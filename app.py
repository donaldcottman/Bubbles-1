...
def run_script():
    ...
    def run_bubbles(result_list, currentCPUProcess, maxCPUProcesses):
        ...
        def bubblesUpdate(stock, stockVolume, AVGDailyVolume):
            ...
            start_timestamp_dataVolumeEndpoint = dt.datetime.fromtimestamp(current_time-4320000)
        ...
        def JSONToBeSentToApp(stocksSorted):
            ...
            for i in range(len(stocksSorted)):
                ...
                bubblesUpdate_result = bubblesUpdate(stocksSorted[i]['stock'], stocksSorted[i]['volume'], stocksSorted[i]['delta_v'])
